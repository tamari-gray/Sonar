...
function create_fragment(ctx) {
	var form, div0, label0, t0, t1, input0, t2, div1, label1, t3, t4, input1, t5, div2, label2, t6, t7, input2, t8, p, t9, a, t10, dispose;
	...
	return {
		c: function create() {
			...
			t8 = space();
			p = element("p");
			t9 = text("already have an account? Login ");
			a = element("a");
			t10 = text("here");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t9 = claim_text(p_nodes, "already have an account? Login ");
		...
		h: function hydrate() {
			...
			attr(a, "href", "login");
			add_location(a, file, 55, 33, 1034);
			attr(p, "class", "svelte-1n3bln9");
			add_location(p, file, 54, 0, 997);
