...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			t10 = space();
			p = element("p");
			t11 = text("already have an account? Sign up\n  ");
			a = element("a");
			t12 = text("here");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t11 = claim_text(p_nodes, "already have an account? Sign up\n  ");
