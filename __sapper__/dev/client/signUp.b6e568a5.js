...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(a, "href", "login");
			add_location(a, file, 56, 2, 1051);
			attr(p, "class", "svelte-11460e");
			add_location(p, file, 54, 0, 1012);
