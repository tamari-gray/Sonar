...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 38, 4, 593);
			attr(input0, "type", "text");
			attr(input0, "name", "userName");
			add_location(input0, file, 39, 4, 638);
			attr(div0, "class", "svelte-5m4mz1");
			add_location(div0, file, 37, 2, 583);
			attr(label1, "for", "email");
			attr(label1, "class", "svelte-5m4mz1");
			add_location(label1, file, 42, 4, 719);
			attr(input1, "type", "text");
			attr(input1, "name", "email");
			add_location(input1, file, 43, 4, 757);
			attr(div1, "class", "svelte-5m4mz1");
			add_location(div1, file, 41, 2, 709);
			attr(label2, "for", "password");
			attr(label2, "class", "svelte-5m4mz1");
			add_location(label2, file, 46, 4, 832);
			attr(input2, "type", "password");
			attr(input2, "name", "password");
			add_location(input2, file, 47, 4, 876);
			attr(div2, "class", "svelte-5m4mz1");
			add_location(div2, file, 45, 2, 822);
			attr(button, "type", "submit");
			add_location(button, file, 50, 4, 961);
			attr(div3, "class", "svelte-5m4mz1");
			add_location(div3, file, 49, 2, 951);
			attr(form, "onsubmit", handleSubmit);
			attr(form, "class", "svelte-5m4mz1");
			add_location(form, file, 36, 0, 550);
			attr(a, "href", "login");
			add_location(a, file, 56, 2, 1057);
			attr(p, "class", "svelte-5m4mz1");
			add_location(p, file, 54, 0, 1018);
